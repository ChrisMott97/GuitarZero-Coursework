...
/**
 * A controller.Button object represents a button/component on the plastic guitar controller.
 *
...
public class Button implements Runnable {
     ...
     *
     * @param l      Object of a class that implements controller.ButtonListener
     */
    ...
    /**
     * Each controller.Button polled forever on it's own thread to ensure a change of state is detected ASAP.
