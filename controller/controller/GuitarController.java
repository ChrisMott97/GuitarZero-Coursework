 ...
 *   $ export CLASSPATH
 *   $ javac controller.GuitarController.java
 *   $ java -Djava.library.path=. controller.GuitarController
 *
...
public class GuitarController {
    ...
    public static void main( String [] args ) {
		...
		for ( int i = 0; i < buttons.length; i = i + 1 ) {
			...
			buttonThread.start();								/* Starting a thread for each controller.Button */
		}
    }
}